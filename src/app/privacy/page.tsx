...
export const metadata: Metadata = {
    title: 'Политика конфиденциальности | Reputa.ru',
    description: 'Политика в отношении обработки персональных данных сервиса Reputa.ru в соответствии с 152-ФЗ.',
}
        ...
        <main>
            ...
            <section className="cst-legal-page">
                <div className="cst-legal-container">
                    <h1 className="cst-legal-title">Политика в отношении обработки персональных данных</h1>
                    ...
                    <Section title="1. Общие положения">
                        <p>
                            ...
                            обеспечению безопасности персональных данных, предпринимаемые ИП Романов Егор Николаевич
                            (далее — Оператор).
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            веб-сайта <a href={SITE_URL} className="cst-legal-link">{SITE_URL}</a>
                        </p>
                    </Section>
                    ...
                    <Section title="2. Основные понятия, используемые в Политике">
                        ...
                        <p>2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href={SITE_URL} className="cst-legal-link">{SITE_URL}</a>.</p>
                        ...
                        <p>2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href={SITE_URL} className="cst-legal-link">{SITE_URL}</a>.</p>
                        <p>2.9. Персональные данные, разрешенные субъектом персональных данных для распространения, — персональные данные, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных путем дачи согласия на обработку персональных данных, разрешенных субъектом персональных данных для распространения в порядке, предусмотренном Законом о персональных данных (далее — персональные данные, разрешенные для распространения).</p>
                        <p>2.10. Пользователь — любой посетитель веб-сайта <a href={SITE_URL} className="cst-legal-link">{SITE_URL}</a>.</p>
                    ...
                    <Section title="6. Цели обработки персональных данных">
                        <div className="cst-legal-table-wrapper">
                            <table className="cst-legal-table">
                                <tbody>
                                    <tr>
                                        <td className="cst-legal-table-label">Цель обработки</td>
                                        <td>предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте</td>
                                    </tr>
                                    <tr>
                                        <td className="cst-legal-table-label">Персональные данные</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td className="cst-legal-table-label">Правовые основания</td>
                                        <td>договоры, заключаемые между оператором и субъектом персональных данных</td>
                                    </tr>
                                    <tr>
                                        <td className="cst-legal-table-label">Виды обработки</td>
                    ...
                    <Section title="8. Порядок сбора, хранения, передачи и других видов обработки персональных данных">
                        ...
                        <p>
                            ...
                            <a href={`mailto:${EMAIL}`} className="cst-legal-link">{EMAIL}</a> с пометкой «Актуализация персональных данных».
                        </p>
                        <p>
                            ...
                            <a href={`mailto:${EMAIL}`} className="cst-legal-link">{EMAIL}</a> с пометкой «Отзыв согласия на обработку персональных данных».
                        </p>
