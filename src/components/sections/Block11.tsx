...
const CARDS: B11Card[] = [
    {
        badge: '<b>Рекомендации</b> AI',
        title: '<blue>ИИ предлагает ваши товары</blue> в ответах на отзыв',
        description: 'увеличивая допродажи <blue>на 15%</blue>',
        reviewer: {
            letter: 'А',
            name: 'Анна',
            stars: '★★★★★',
    ...
    {
        badge: 'Работа с <b>негативом</b>',
        title: 'ИИ корректно <blue>отвечает на негатив</blue>',
        description: 'и <blue>помогает сохранить лояльность </blue> даже недовольного покупателя',
        reviewer: {
            letter: 'И',
            name: 'Ирина',
            stars: '★★★★★',
    ...
    {
        badge: 'Работа с <b>вопросами</b>',
        title: 'ИИ <blue>мгновенно отвечает</blue> на вопросы',
        description: 'и помогает клиенту принять решение о покупке <blue>без участия менеджера</blue>',
        reviewer: {
            letter: 'В',
            name: 'Виталий',
            stars: '',
