...
const TITLE = 'Что можно отправлять<br/>покупателям <blue> через рассылки?</blue>'

const CARDS = [
    {
        Icon: Block24svg1,
        title: 'Скидки и акции',
        description: 'Возвращайте покупателей специальными<br/>предложениями и увеличивайте повторные<br/>продажи',
    },
    {
        Icon: Block24svg2,
        title: 'Новинки и другие товары',
        description: 'Рекомендуйте товары вашей линейки <br/>и стимулируйте дополнительные покупки',
    },
    {
        Icon: Block24svg3,
        title: 'Сбой обратной связи',
        description: 'Получайте обратную связь от покупателей <br/>для развития бренда и улучшения качества',
    },
    {
        Icon: Block24svg4,
        title: 'Напоминание о повторной покупке',
        description: 'Напоминайте клиентам о повторном заказе <br/>товаров, которые требуют регулярного <br/>обновления или расходуются со временем',
    },
]
