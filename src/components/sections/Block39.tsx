...
const TITLE = 'Reputa<blue> экономит  до 95% времени</blue> менеджера'
const DESCRIPTION = '100 отзывов и вопросовв день <b>— это до 8 часов ручной работы</b>'
const SUB_DESCRIPTION = 'Reputa <blue>автоматически отвечает покупателям  рекомендует товары </blue>и не забывает о допродажах'
const BEFORE_CARDS_TEXT = 'Вместо рутины ваш менеджер занимаетсятем, <b>что увеличивает продажи:</b>'

const CARDS = [
    'Улучшает карточки товаров',
    'Тестирует гипотезы',
