...
const ITEMS = [
    {
        ...
        title: 'Ответ <blue> за 1 секунду</blue>',
        description: 'ИИ мгновенно генерирует и публикует ответы без задержек',
    },
    {
        number: '2',
        imageSrc: '/images/Block12Img2.png',
        imageAlt: 'Block12Img2',
        title: 'Полная <blue>автоматизация</blue>',
        description: 'Ответы публикуются без участия менеджеров — до 95% экономии времени на обработке отзывов и вопросов',
    },
    {
        number: '3',
        ...
        description: 'AI обращается к покупателю по имени и отвечает в заданном стиле, повышая доверие и лояльность',
    },
    {
        number: '4',
