...
const ITEMS = [
    {
        ...
        title: 'Все чаты с покупателями <br/><blue>в одном месте</blue>',
        description: 'Работайте со всеми сообщениями в одном <br/>окне без зависаний и переключений между <br/>кабинетами — быстрее отвечаете <br/>и не теряете клиентов',
    },
    {
        number: '2',
        imageSrc: '/images/Block28Img2.png',
        imageAlt: 'Block28Img2',
        title: 'Помогайте покупателю <br/><blue>до оформления заказа</blue>',
        description: 'Отвечайте на вопросы в чате ещё до <br/>покупки: помогайте выбрать товар, снижайте <br/>риск возвратов и негативных отзывов',
    },
    {
        number: '3',
        imageSrc: '/images/Block28Img3.png',
        imageAlt: 'Block28Img3',
        title: '<blue>Полная история</blue> общения <br/>с покупателями',
        description: 'Все диалоги сохраняются — вы видите <br/>переписку целиком, контролируете <br/>качество ответов и работу  <br/>менеджеров',
    },
    {
        number: '4',
        imageSrc: '/images/Block28Img4.png',
        imageAlt: 'Block28Img4',
        title: 'Не пропускайте <br/><blue>ни одного сообщения</blue>',
        description: 'Если вы не ответили в течение 5 минут<br/>— система отправит уведомление.<br/>Вы контролируете каждый диалог<br/>и не теряете покупателей',
    },
]
