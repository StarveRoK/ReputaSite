...
const ITEMS = [
    ...
    },
    {
        ...
        title: 'Экономия <blue> до 40%</blue> рекламного бюджета',
    ...
    },
    {
        ...
        description: 'Регулярные касания через рассылки помогают покупателям чаще возвращаться именно к вашему магазину',
    },
    {
        number: '4',
        imageSrc: '/images/Block23Img4.png',
        imageAlt: 'Block23Img4',
        title: 'Повторные продажи<blue> без дополнительных вложений</blue>',
