...
const JOURNAL = {
    ...
    description: 'Делимся кейсами, исследованиями, аналитикой<br/>и практическим опытом работы с отзывами, <br/>покупателями и репутацией брендов',
    ctaHref: '#',
...
const PODCAST = {
    ...
    description: 'Записываем интервью и подкасты с селлерами,<br/>экспертами и предпринимателями рынка<br/>маркетплейсов',
}
