...
const FAQS: { question: string; answer: string }[] = [
    ...
    },
    {
        ...
        answer: 'При запуске система анализирует:\n• ваши предыдущие ответы на отзывы и вопросы;\n• карточки товаров;\n• описания и инфографику;\n• инструкции и FAQ по товарам;\n• дополнительные материалы, которые вы предоставите.\n\nНа основе этих данных AI формирует базу знаний и стиль общения, весь период обучения AI проходит 14 дней.\n\nВ этот период вы можете корректировать ответы, а система будет учитывать вашу обратную связь и постепенно адаптироваться под ваш стиль общения.',
    },
    {
        question: 'Что делать, если у нас сложный или технический товар?',
        answer: 'Это не проблема.\n\nЕсли у вас есть инструкции, техническая документация, FAQ или внутренние знания, мы загрузим их в систему. Даже для узкоспециализированных товаров AI сможет формировать точные ответы на основе вашей информации.',
    },
    {
        question: 'Можно ли проверять ответы перед публикацией?',
        answer: 'Да. Вы можете выбрать:\n• полностью автоматическую публикацию;\n• режим предварительного согласования;\n• смешанный формат работы.',
    },
    {
