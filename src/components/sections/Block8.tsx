...
const FAQS: { question: string; answer: string }[] = [
    ...
    },
    {
        ...
        answer: 'При запуске система анализирует:• ваши предыдущие ответы на отзывы и вопросы;• карточки товаров;• описания и инфографику;• инструкции и FAQ по товарам;• дополнительные материалы, которые вы предоставите.На основе этих данных AI формирует базу знаний и стиль общения, весь период обучения AI проходит 14 дней.В этот период вы можете корректировать ответы, а система будет учитывать вашу обратную связь и постепенно адаптироваться под ваш стиль общения.',
    },
    {
        question: 'Что делать, если у нас сложный или технический товар?',
        answer: 'Это не проблема.Если у вас есть инструкции, техническая документация, FAQ или внутренние знания, мы загрузим их в систему. Даже для узкоспециализированных товаров AI сможет формировать точные ответы на основе вашей информации.',
    },
    {
        question: 'Можно ли проверять ответы перед публикацией?',
        answer: 'Да. Вы можете выбрать:• полностью автоматическую публикацию;• режим предварительного согласования;• смешанный формат работы.',
    },
    {
