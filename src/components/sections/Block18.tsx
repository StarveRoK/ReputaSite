...
const FOOTER_TEXT = 'Сигналы, которые показывают, что репутация <br/>товара уже влияет на продажи'
...
const LIST_ITEMS = [
    ...
    'Рейтинг вашего товара ниже, <br/>чем у конкурентов в нише',
    'Проседает конверсия в заказ',
    'Негативные отзывы попадают в "важное <br/>из отзывов" и влияют на восприятие товара',
]
